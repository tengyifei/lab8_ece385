...
module lab8_soc_mm_interconnect_0 (
	...
	wire   [13:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> key2_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // key2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key2_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key3_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key3_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key3_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> otg_hpi_data_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // otg_hpi_data_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> otg_hpi_data_s1_agent:cp_channel
	...
	wire  [106:0] key2_s1_agent_rp_data;                                                              // key2_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [106:0] key3_s1_agent_rp_data;                                                              // key3_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [106:0] otg_hpi_data_s1_agent_rp_data;                                                      // otg_hpi_data_s1_agent:rp_data -> router_014:sink_data
